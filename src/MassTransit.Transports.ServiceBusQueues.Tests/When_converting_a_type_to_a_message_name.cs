...
namespace MassTransit.Transports.ServiceBusQueues.Tests
{
	...
	public class When_converting_a_type_to_a_message_name
	{
		...
		public void Should_handle_an_interface_name()
		{
			...
			name.ToString().ShouldEqual("MassTransit.Transports.ServiceBusQueues.Tests..NameEasyToo");
		}
		...
		public void Should_handle_nested_classes()
		{
			...
			name.ToString().ShouldEqual("MassTransit.Transports.ServiceBusQueues.Tests..When_converting_a_type_to_a_message_name-Nested");
		}
		...
		public void Should_handle_regular_classes()
		{
			...
			name.ToString().ShouldEqual("MassTransit.Transports.ServiceBusQueues.Tests..NameEasy");
		}
		...
		public void Should_handle_a_closed_single_generic()
		{
			...
			name.ToString().ShouldEqual("MassTransit.Transports.ServiceBusQueues.Tests..NameGeneric--System..String--");
		}
		...
		public void Should_handle_a_closed_double_generic()
		{
			...
			name.ToString().ShouldEqual("MassTransit.Transports.ServiceBusQueues.Tests..NameDoubleGeneric--System..String....NameEasy--");
		}
		...
		public void Should_handle_a_closed_double_generic_with_a_generic()
		{
			...
			name.ToString().ShouldEqual("MassTransit.Transports.ServiceBusQueues.Tests..NameDoubleGeneric--NameGeneric--NameEasyToo--....NameEasy--");
		}
