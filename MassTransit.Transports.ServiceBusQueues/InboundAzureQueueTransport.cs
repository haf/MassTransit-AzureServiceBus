...
{
	public class InboundAzureQueueTransport
        : IInboundTransport
    {
        ...
        public InboundAzureQueueTransport(IEndpointAddress address, ConnectionHandler<ServiceBusQueueConnection> connectionHandler)
        {
